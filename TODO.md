...
- Be more strict with which notes/intervals we show and how we name them (e.g. we shouldn't show C# for Db root note, or the intervals should match the definition and not the canonical interval)
